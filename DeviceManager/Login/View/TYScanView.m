...
@interface TYScanView () <AVCaptureMetadataOutputObjectsDelegate>
...
- (BOOL)statusCheck {
    if (![self isCameraAvailable]){
        [SVProgressHUD showErrorWithStatus:kStrNoPermission];
        return NO;
    }
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray<AVMetadataMachineReadableCodeObject *> *)metadataObjects fromConnection:(AVCaptureConnection *)connection {
    ...
    if (self.qrInfoCallBack) {
        self.qrInfoCallBack(result);
    }
